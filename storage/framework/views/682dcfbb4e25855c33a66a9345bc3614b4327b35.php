    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $diaristas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diarista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <td> <?php echo e($diarista->telefone); ?> </td>
            <td>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Thierry\Pictures\Faculdade\Certificado\Cursos Online\TreinaWeb\treinaweb-multistack\e-diaristas\resources\views/index.blade.php ENDPATH**/ ?>